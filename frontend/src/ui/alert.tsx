...
const variantClasses = {
  ...
  error: {
    container: 'bg-error-25 border-error-200',
    icon: 'text-error-600',
...
const AlertIcon: React.FC<{ variant: AlertProps['variant'] }> = ({ variant = 'info' }) => {
    ...
    >
      <div className="flex">
        ...
        <div className="ml-3 flex-1">
          ...
          <div className={cn('text-sm', classes.description, title && 'mt-1')}>
            {children}
          </div>
        </div>
        {onClose && (
