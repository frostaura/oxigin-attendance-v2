...
// Simple SVG icons with UntitledUI styling
export const PlayIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <polygon points="9,8 9,16 15,12" fill="currentColor" />
  </svg>
);
...
export const PeopleIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
